/*************************************************************************
	> File Name: BufferEventServer.cpp
	> Author: 
	> Mail: 
	> Created Time: Sun 14 Oct 2018 09:19:14 PM CDT
 ************************************************************************/
        ...
        evutil_socket_t fd, struct sockaddr *addr, int addrLen, void *arg)
{
    ...
    bufferevent *bev = bufferevent_socket_new(base, fd, int options);
...
int main(int argc, char* argv[])
{
    ...
    if (argc!=1 && argc!=3) {
        std::cout << "run as follow.\n\t./bufferEventSer bindhost bindport\n\t./bufferEventSer" << std::endl;
        return -1;
    }
